export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	missingno: {
		...
		abilities: { 0: "No Ability", H: "No Guard" },
		heightm: 3,
		weightkg: 1590.8,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	blottle: {
		...
		types: ["Fairy", "Normal"],
		gender: "F",
		baseStats: { hp: 70, atk: 70, def: 90, spa: 120, spd: 80, spe: 100 },
		abilities: { 0: "Pixilate", 1: "Libero", H: "Magic Bounce" },
		heightm: 0.65,
		weightkg: 1.2,
		color: "Pink",
		eggGroups: ["Undiscovered"],
		gen: 7,
		tags: ["Sub-Legendary"],
		otherFormes: ["Blottle-Fumage", "Blottle-Sculpt"],
		formeOrder: ["Blottle", "Blottle-Fumage", "Blottle-Neon"],
	},
	blottlefumage: {
		num: -82,
		name: "Blottle-Fumage",
		...
		types: ["Fairy", "Fire"],
		gender: "F",
		baseStats: { hp: 80, atk: 80, def: 90, spa: 145, spd: 95, spe: 110 },
		abilities: { 0: "Monoxide" },
		heightm: 0.875,
		weightkg: 0.5,
		color: "Black",
		eggGroups: ["Undiscovered"],
		gen: 7,
		requiredItem: "Red Paint"
	},
	blottlepuppeteer: {
		num: -83,
		name: "Blottle-Puppeteer",
		baseSpecies: "Blottle",
		forme: "Art",
		types: ["Fairy", "Fighting"],
		gender: "F",
		baseStats: { hp: 90, atk: 140, def: 120, spa: 70, spd: 80, spe: 100 },
		abilities: { 0: "Bait n\' Switch" },
		heightm: 0.65,
		weightkg: 2.35,
		color: "Brown",
		eggGroups: ["Undiscovered"],
		gen: 7,
		requiredItem: "Orange Paint"
	},
	blottleneon: {
		num: -82,
		name: "Blottle-Neon",
		...
		gender: "F",
		baseStats: { hp: 60, atk: 60, def: 85, spa: 160, spd: 75, spe: 160 },
